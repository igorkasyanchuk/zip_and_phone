...
module SimpleCaptcha #:nodoc
  module ImageHelpers #:nodoc
    ...
    def append_simple_captcha_code #:nodoc      
      ...
      value = @simple_captcha_image_options[:simple_captcha_key] || "list.if.ua"
      text.annotate(@image, 0, 0, 0, 5, simple_captcha_value(value) || "list.if.ua") do
    ...
    def generate_simple_captcha_image(options={})  #:nodoc
      @image = Magick::Image.new(80, 22) do 
