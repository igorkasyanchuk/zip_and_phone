...
Gem::Specification.new do |s|
  s.name = %q{blakechambers-dry_scaffold}
  s.version = "0.3.6"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Jonas Grimfelt,Michel de Graaf,Blake Chambers"]
  s.date = %q{2009-11-02}
  ...
  s.email = %q{grimen@gmail.com, michel@re-invention.nl, chambb1@gmail.com}
  ...
  s.homepage = %q{http://github.com/blakechambers/blakechambers-dry_scaffold/tree/master}
